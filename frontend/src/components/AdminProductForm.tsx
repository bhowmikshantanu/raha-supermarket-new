...
export function AdminProductForm({ mode, product }: ProductFormProps) {
  ...
  const selectedCategoryName = useMemo(
    () => CATEGORIES.find((category) => category.id === form.category)?.name ?? "Select category",
    [form.category],
  );
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      showToast("Unable to save product. Check admin login and Firestore rules.", "error");
    } finally {
      setSaving(false);
    }
  };
      ...
      >
        ...
        >
          ...
          <Section title="Product Image" icon="image-outline">
            ...
            />
            <Text style={styles.helperText}>
              Firebase Storage upload will be added later. For now, paste a direct image URL.
            </Text>
            <View style={styles.previewCard}>
              {form.image.trim() && !imageFailed ? (
                ...
                <View style={styles.previewFallback}>
                  ...
                  <Text style={styles.previewFallbackText}>Image preview</Text>
                </View>
              )}
            </View>
          </Section>
          ...
          <Button
            label={saving ? "Saving Product…" : isEditing ? "Save Changes" : "Add Product"}
...
const styles = StyleSheet.create({
  ...
  previewFallbackText: { marginTop: SPACING.sm, fontSize: FONT.size.xs, color: COLORS.textMuted },
