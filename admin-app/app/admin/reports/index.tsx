...
const styles = StyleSheet.create({
  ...
  sectionTitle: { marginTop: SPACING.lg, marginBottom: SPACING.sm, fontSize: FONT.md, fontWeight: "900", color: COLORS.textPrimary },
  ...
  metricValue: { marginTop: SPACING.md, fontSize: FONT.xl, fontWeight: "900", color: COLORS.textPrimary },
  ...
  smallMetricValue: { marginTop: 5, fontSize: FONT.lg, fontWeight: "900", color: COLORS.textPrimary },
